"""Remove warehouse_connections table (warehouse connector feature removed).

Revision ID: 0011_remove_warehouse_connections
Revises: 0010_warehouse_connections
...
revision: str = "0011_remove_warehouse_connections"
down_revision: Union[str, None] = "0010_warehouse_connections"

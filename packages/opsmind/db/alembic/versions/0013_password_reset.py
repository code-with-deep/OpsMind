"""Password reset tokens + password_changed_at / token_version.

Revision ID: 0013_password_reset
Revises: 0012_access_requests_notifications
...
down_revision: Union[str, None] = "0012_access_requests_notifications"
